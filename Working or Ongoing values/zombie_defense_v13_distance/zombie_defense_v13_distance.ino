...
//============================================
// LANE PRIORITY (Distance mode bonuses) - AGGRESSIVE
//============================================
const float LANE_PRIORITY[4] = {1.0, 1.35, 1.35, 1.15};  // L2/L3 get 35% boost

// Distance thresholds (0% = start, 100% = impact)
const float EARLY_ENGAGE_THRESHOLD_LONG = 0.03;   // L1/L4: engage when > 3%
const float EARLY_ENGAGE_THRESHOLD_SHORT = 0.02;  // L2/L3: engage when > 2%
const float MIN_ENGAGE_THRESHOLD = 0.98;          // Allow engaging up to 98%

// Override thresholds - AGGRESSIVE
const float OVERRIDE_THRESHOLD[4] = {0.80, 0.40, 0.40, 0.80};
const float ABSOLUTE_EMERGENCY_THRESHOLD = 0.70;  // 70% = immediate attention
const float EXTREME_EMERGENCY_THRESHOLD = 0.85;   // 85% = game-ending
const float SHORT_LANE_CRITICAL_DISTANCE = 0.35;  // L2/L3 critical at 35%
const float LONG_LANE_CRITICAL_DISTANCE = 0.70;   // L1/L4 critical at 70%

// Retreat/Gone thresholds - FASTER EXIT
const float RETREAT_CONFIRMED_DISTANCE = 0.50;
...
const unsigned long NORMAL_DWELL_TIME = 300;        // Faster transitions
...
//============================================
bool shouldRecalculateForCriticalLane() {
  const float CRITICAL_THRESHOLD = 0.55;  // 55% = critical (more aggressive)
