...
//============================================
// LANE PRIORITY (TTI mode adjustments) - AGGRESSIVE
//============================================
const float LANE_PRIORITY[4] = {1.0, 1.35, 1.35, 1.15};  // L2/L3 get 35% boost

// TTI thresholds - MORE AGGRESSIVE
const int TTI_EMERGENCY_THRESHOLD[4] = {600, 900, 900, 600};   // Higher = trigger earlier
const int TTI_MIN_ENGAGE[4] = {400, 600, 600, 400};            // Engage sooner
const int TTI_MAX_ENGAGE[4] = {3000, 4000, 4000, 3000};        // Engage from further
const int SHORT_LANE_TTI_BOOST = 350;  // More boost for L2/L3 (subtract from TTI)

// Distance thresholds (fallback) - EARLIER ENGAGEMENT
